    ...
    <div className="food-page">
      ...
      <div className="input-group">
        ...
        <select
          className="custom-food-select"
          name="diet"
          onClick={(e) => setDiet(e.target.value)}
        >
      ...
      <button className="input-group-button" onClick={onSubmit}>
        Search
      </button>
      <div className="options">
        {!validSearch ? (
          ...
          <div>No options found. Change choices or finish.</div>
        ) : (
          <>
      ...
      {validSearch && (
        <button className="input-group-button" onClick={submitChoice}>
          Finish
        </button>
      )}
    </div>
